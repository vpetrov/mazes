...
func binary_tree(grid:Grid, start_cell:Cell) -> void:
...
func sidewinder(grid:Grid, start_cell:Cell) -> void:
    for row in range(grid.nrows):
        var run = []
...
func aldousBroder(grid:Grid, start_cell:Cell) -> void:
    var cell = start_cell
...
func wilson(grid:Grid, start_cell:Cell) -> void:
    var unvisited = []
...
func huntKill(grid:Grid, start_cell:Cell) -> void:
    var cell = start_cell
