...
func gridToMesh(grid:DistanceGrid) -> ArrayMesh:
...
func addVerticalFace(surface:SurfaceTool, origin:Vector3, width: float, height: float) -> void:
    surface.add_color(Color(1, 0, 0))
    surface.add_uv(Vector2(0,0))
    surface.add_vertex(origin + Vector3(0.0, 0.0, 0.0))
    surface.add_color(Color(0, 1, 0))
    surface.add_uv(Vector2(128,128))
    surface.add_vertex(origin + Vector3(0.0, height, width))
    surface.add_color(Color(0, 0, 1))
    surface.add_uv(Vector2(128,0))
